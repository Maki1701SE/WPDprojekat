...
@section('title', 'Izmijeni kategoriju')

@section('content')
    <div class="max-w-2xl mx-auto">
        <h1 class="text-2xl font-bold text-gray-700 mb-6">Izmijeni kategoriju</h1>
            ...
            <form action="{{ route('categories.update', $category) }}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description" rows="4"
                              class="w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400">{{ old('description', $category->description) }}</textarea>
                </div>
